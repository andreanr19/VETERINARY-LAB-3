...
public class Service {
	...
	/**
	 * Description The method allows to obtain the type of service. 
	...
	/**
	 * Description The method allows to obtain the price of service. 
	...
	/**
	 * Description The method allows to obtain the name of the pet's owner that is receiving the service. 
...
//	}
	...
	/**
	 * Description The method allows to obtain the id of the pet's owner that is receiving the service. 
...
//	}
	...
	/**
	 * Description The method allows to obtain the name of the pet that is receiving the service. 
...
//	}
	...
	/**
	 * Description The method allows to obtain the client that is owner of the pet which is receiving the service. 
	 * pre:Existence of relationship between client and the service. The client already has his/her pet.
	 * 
	 * 
	 * @return:A String representing the name of the pet's owner
	 */
	...
	/**
	 * Description The method allows to set the client of the pet that is receiving the service
	 * pre: The pet and the client are created before
	 * post: The client has been set by parameter for an Client object.
	 * @param theClientService
	 */
	...
	/**
	 * Description The method allows to obtain the pet pet which is receiving the service. 
	 * pre:Existence of relationship between pet and the service. The pet is alrady created.
	 * 
	 * 
	 * @return:A String representing the name of the pet's owner
	 */
	 ...
	 * post: The pet that is receiving the service is set by parameter
	 * @param petService
	 */
	...
	/**
	 * Description The method allows to set the price of the service based on its type
	 * pre: the type of the service should be one of the statics Strings initialized before
	 * post: the price of the service is calculated and set.
	 * @param typeService
